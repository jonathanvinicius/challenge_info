import { PageDto, PageMetaDto, PageOptionsDto } from '@app/domain/dtos';
  ...
  implements IBaseRepository<T>
{
  ...
  private async handlePagination(
    ...
    const data = this.toPlainInstance(results.rows, cls); // results.rows.map((i) => this.toPlainToClass(i));
